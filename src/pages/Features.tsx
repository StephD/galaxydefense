...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Create your player profile, track achievements, and connect with other Galaxy Defense players.",
      highlight: false
    },
    {
      icon: MessageSquare,
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Discover all the tools and features that make Galaxy Defense the ultimate space strategy game
          </p>
        </div>
